...
$(document).ready(function () {
    ...
    $('#submit').click(function (e) {
        const uploadLocation = "C:\\Users\\Raen Reyes\\Downloads";
        $.ajax({
            type: "POST",
            url: "https://localhost:7093/home/apply",
            dataType: "JSON",
            data: {
                firstName: $('#firstName').val(),
                lastName: $('#lastName').val(),
                ...
                state: $('#state').val(),
                phone: $('#phone').val(),
                resume: function () { return $('#resume').val().replace("C:\\fakepath", uploadLocation); }

            },
            success: function (payload) {
                $('#firstName').val(payload.name)
            }
        });
    });
